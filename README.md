...
Проект для фоток еды и публикации рецептов.
Реализован с использованием drf. Настроена развёртка в docker контейнерах при помощи ci/cd на удобном для вас сервере.
